...
public final class ErrorKeys {
     ...
     * Delete group
     */
    public static final String DELETE_GROUP_ERROR_TITLE = "create.group.error.title";
    public static final String DELETE_GROUP_ERROR_MESSAGE = "create.group.error.message";
